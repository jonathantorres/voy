...
char *test_conf_load()
{
    ...
    voy_assert(strcmp(conf->user->string, "www-data") == 0,
               "The main user in the conf file must be www-data");
    voy_assert(strcmp(conf->group->string, "www-data") == 0,
               "The main group in the conf file must be www-data");
...
char *test_default_server()
{
    ...
    voy_assert(strcmp(def_server->root->string, "/var/www/localhost") == 0,
               "The root strings are not the same");
    voy_assert(strcmp(def_server->error_log->string, "/etc/log/voy/errors.log") == 0,
               "The strings of the error log are not the same");
    voy_assert(strcmp(def_server->access_log->string, "/etc/log/voy/access.log") == 0,
               "The strings of the access log are not the same");
...
char *test_virtual_hosts()
{
    ...
    voy_assert(strcmp(mydom_server->root->string, "/var/www/mydomain.com/public") == 0,
               "The root strings are not the same");
    voy_assert(strcmp(mydom_server->error_log->string, "/etc/log/voy/mydomain.com.log") == 0,
               "The strings of the error log are not the same");
    voy_assert(strcmp(mydom_server->access_log->string, "/etc/log/voy/mydomain.com.log") == 0,
               "The strings of the access log are not the same");
    ...
    voy_assert(strcmp(f_name->string, "mydomain.com") == 0,
               "The server name should be mydomain.com");
    voy_assert(strcmp(s_name->string, "www.mydomain.com") == 0,
               "The server name should be www.mydomain.com");
    ...
    voy_assert(strcmp(another_server->root->string, "/var/www/another.com/public") == 0,
               "The root strings are not the same");
    voy_assert(strcmp(another_server->error_log->string, "/etc/log/voy/another.com.log") == 0,
               "The strings of the error log are not the same");
    voy_assert(strcmp(another_server->access_log->string, "/etc/log/voy/another.com.log") == 0,
               "The strings of the access log are not the same");
