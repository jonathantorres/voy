...
void voy_array_set(voy_array_t *arr, void *elem, unsigned int index);
void *voy_array_get(voy_array_t *arr, unsigned int index);
void *voy_array_remove(voy_array_t *arr, unsigned int index);
