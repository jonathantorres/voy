...
voy_conf.o: voy_conf.c voy_conf.h
	$(CFLAGS) -c src/voy_conf.c src/voy_conf.h
...
# Run tests
.PHONY: test
test: voy_dl_list_test voy_array_test voy_htable_test voy_str_test voy_request_test
	./bin/voy_dl_list_test
	./bin/voy_array_test
	./bin/voy_htable_test
	./bin/voy_str_test
	./bin/voy_request_test
